...
draft = false
toc = true
images = ['/images/THM-The_Sticker_Shop/Sticker_shop.png']
tags = ['TryHackMe']
categories = ['Writeups']
+++
...
Nous savons que le drapeau se trouve à `http://10.10.139.96:8080/flag.txt`, nous pouvons donc utiliser un script modifié afin de le recevoir sur notre serveur web.
